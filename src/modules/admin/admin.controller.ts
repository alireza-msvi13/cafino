...
export class AdminController {
  ...
  async getOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'Dashboard overview fetched successfully.', result);
  }
  ...
  async getUserOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'User overview fetched successfully.', result);
  }
  ...
  async getOrderOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'Order overview fetched successfully.', result);
  }
  ...
  async getItemOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'Item overview fetched successfully.', result);
  }
  ...
  async getDiscountOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'Discount overview fetched successfully.', result);
  }
  ...
  async getRevenueOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'Revenue overview fetched successfully.', result);
  }
  ...
  async getMessageOverview() {
    ...
    return new ServerResponse(HttpStatus.OK, 'Message overview fetched successfully.', result);
  }
